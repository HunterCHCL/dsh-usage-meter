    ...
    async function apply(ctx) {
      ...
      slots.inject("conversation.session.header.utilities", function () {
        return slots.register(
          { name: "conversation.session.header.utilities", id: "dsh-usage-meter-top", order: -10, label: function () { return "余额 / 用量" } },
      ...
      slots.inject("settings.section", function () {
        return slots.register(
          { name: "settings.section", id: "dsh-usage-meter", order: 30, label: function () { return "余额 / 用量" } },
